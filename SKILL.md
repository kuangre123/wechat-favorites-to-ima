...
description: Use when migrating WeChat Favorites articles into ima.copilot knowledge bases. Extract only trusted article URLs by right-clicking items in the WeChat Favorites list, filtering mp.weixin.qq.com/s links, deduplicating them, and importing them through ima's "网页链接" batch importer.
---
...
ima's "网页链接" dialog supports multiple links separated by newlines, usually up to 10 links per batch.
